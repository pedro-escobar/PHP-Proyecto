<?php
    ...
    $con = mysqli_connect(HOST_DB, USUARIO_DB, USUARIO_PASS, NOMBRE_DB);
    $sql = 'CREATE table Creditos (id Int Not Null Auto_Increment, idCliente Int Null, javeCoins decimal(10,2), fechaPago date, correoVisitante varchar(50), pagado bit, fechaPagado date, primary key (id), foreign key (idCliente) references Usuarios(id));';
